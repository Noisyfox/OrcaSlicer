...
void BBLTopbar::Init(wxFrame* parent) 
{
    ...
    auto& file_bitmap = *get_bmp_bundle("topbar_file", TOPBAR_ICON_SIZE);
    ...
    auto& dropdown_bitmap = *get_bmp_bundle("topbar_dropdown", TOPBAR_ICON_SIZE);
    ...
    //auto& open_bitmap = *get_bmp_bundle("topbar_open", TOPBAR_ICON_SIZE);
    //wxAuiToolBarItem* tool_item = this->AddTool(wxID_OPEN, "", open_bitmap);

    this->AddSpacer(FromDIP(10));

    auto& save_bitmap = *get_bmp_bundle("topbar_save", TOPBAR_ICON_SIZE);
    wxAuiToolBarItem* save_btn = this->AddTool(wxID_SAVE, "", save_bitmap);

    this->AddSpacer(FromDIP(10));

    auto& undo_bitmap = *get_bmp_bundle("topbar_undo", TOPBAR_ICON_SIZE);
    m_undo_item = this->AddTool(wxID_UNDO, "", undo_bitmap);
    auto& undo_inactive_bitmap = *get_bmp_bundle("topbar_undo_inactive", TOPBAR_ICON_SIZE);
    m_undo_item->SetDisabledBitmap(undo_inactive_bitmap);

    this->AddSpacer(FromDIP(10));

    auto& redo_bitmap = *get_bmp_bundle("topbar_redo", TOPBAR_ICON_SIZE);
    m_redo_item = this->AddTool(wxID_REDO, "", redo_bitmap);
    auto& redo_inactive_bitmap = *get_bmp_bundle("topbar_redo_inactive", TOPBAR_ICON_SIZE);
    m_redo_item->SetDisabledBitmap(redo_inactive_bitmap);

    this->AddSpacer(FromDIP(10));

    auto& calib_bitmap          = *get_bmp_bundle("calib_sf", TOPBAR_ICON_SIZE);
    auto& calib_bitmap_inactive = *get_bmp_bundle("calib_sf_inactive", TOPBAR_ICON_SIZE);
    ...
    /*auto& model_store_bitmap = *get_bmp_bundle("topbar_store", TOPBAR_ICON_SIZE);
    ...
    */
    ...
    auto& iconize_bitmap = *get_bmp_bundle("topbar_min", TOPBAR_ICON_SIZE);
    ...
    auto& close_bitmap = *get_bmp_bundle("topbar_close", TOPBAR_ICON_SIZE);
...
void BBLTopbar::Rescale() {
    ...
    //item->SetBitmap(*get_bmp_bundle("topbar_open", TOPBAR_ICON_SIZE));
