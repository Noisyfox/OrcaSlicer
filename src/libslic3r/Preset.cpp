...
static std::vector<std::string> s_Preset_print_options {
    ...
    "fuzzy_skin", "fuzzy_skin_thickness", "fuzzy_skin_point_distance", "fuzzy_skin_first_layer","atc_enable_tool_clustering",
    "atc_safe_batch_height", "atc_critical_intersection_area", "atc_extruders_z_jump", "atc_wiping_volume",
